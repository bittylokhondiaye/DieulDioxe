...
// Returns the private 'App\Repository\CommissionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommissionsRepository.php';

return $this->privates['App\\Repository\\CommissionsRepository'] = new \App\Repository\CommissionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
