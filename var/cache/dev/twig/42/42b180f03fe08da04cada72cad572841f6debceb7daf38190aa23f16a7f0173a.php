...
<?php echo \$view['form']->block(\$form, 'form_widget_simple', ['type' => isset(\$type) ? \$type : 'text']).\$view->escape(\$symbol) ?>
", "@Framework/Form/percent_widget.html.php", "/var/www/html/SYMFONY/API/DieulDioxe/DieulDioxe/vendor/symfony/framework-bundle/Resources/views/Form/percent_widget.html.php");
    }
}
