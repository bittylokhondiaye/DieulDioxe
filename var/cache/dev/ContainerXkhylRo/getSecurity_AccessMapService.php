...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/userPartenaires'), [0 => 'ROLE_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/login'), [0 => 'ROLE_BLOQUE'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/compte'), [0 => 'ROLE_CAISSIER'], NULL);
